					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 0904078692</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> duchanh12052001@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li><a href="https://www.facebook.com/NguyenMinhDuc12052001"><i class="fab fa-facebook"></i></a></li>
    		...
    		<div class="row" style="margin-top: 100px;">  	
	    			...
	    			<div class="contact-form">
				    	...
				    	<form id="main-contact-form" class="contact-form row" name="contact-form" method="post">
				            ...
				            <div class="form-group col-md-12">
				                <textarea name="message" id="message" required="required" class="form-control" rows="8" placeholder="Nội Dung Liên Hệ"></textarea>
				            </div>                        
				            <div class="form-group col-md-12">
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>LaptopDH</p>
							<p>Cầu Cót - Hà Nội - Việt Nam</p>
							<p>Số Điện thoại: 0904078692</p>
							<p>Email: duchanh12052001@gmail.com</p>
	    				</address>
	    			</div>
    			</div>    			
	    	</div>  
